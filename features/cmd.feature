...
Scenario: Add a single time to the filter job
    ...
    Then the filter options for time contains the result "(1) April 2004"
...
Scenario: Add a time range to the filter job
    ...
    Then the filter options for time contains the result "(3) June 2001, July 2001, August 2001"
...
Scenario: Add a list of times to the filter job
    ...
    Then the filter options for time contains the result "(3) February 1999, January 2004, December 2007"
